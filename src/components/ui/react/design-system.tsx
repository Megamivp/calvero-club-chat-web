...
export const Nav = ({
  ...
  <nav className={cn(className, "w-full")} id={id} style={style}>
    <div
      id="nav-container"
...
/**
 * PageSeperator component to visually separate sections of a page.
 *
 * @param {DSProps} props - Component props.
 * @returns {JSX.Element} A vertical separator element.
 */
export const PageSeparator = () => (
  <div className="mx-auto my-10 h-28 w-1 rounded-full bg-muted" />
);
  ...
  return (
    <Component
      className={cn(
        ...
        "[&_h4]:text-balance [&_h4]:text-xl [&_h4]:tracking-tight sm:[&_h4]:text-2xl",
        "[&_h5]:text-balance [&_h5]:text-lg [&_h5]:tracking-tight sm:[&_h5]:text-xl",
        "[&_h6]:text-balance [&_h6]:text-base [&_h6]:tracking-tight sm:[&_h6]:text-lg",
        // Paragraph styles
        ...
        "[&_dt:not(:first-child)]:mt-3 [&_dt]:text-sm [&_dt]:font-medium [&_dt]:leading-snug",
        ...
        "[&_thead]:bg-muted/50",
        "[&_tr:nth-child(even)]:bg-muted/20 [&_tr]:border-b",
        ...
        // Block elements
        "[&_blockquote]:pl-4! [&_blockquote]:my-4 [&_blockquote]:border-l-4 [&_blockquote]:border-border [&_blockquote]:bg-muted/30 [&_blockquote]:py-2 [&_blockquote]:text-muted-foreground",
        ...
        "focus-visible:[&_summary]:outline-hidden [&_summary]:cursor-pointer [&_summary]:font-semibold",
        // Interactive elements
        "[&_kbd]:shadow-xs [&_kbd]:rounded-sm [&_kbd]:border [&_kbd]:bg-muted [&_kbd]:px-1.5 [&_kbd]:py-0.5 [&_kbd]:align-middle [&_kbd]:font-mono [&_kbd]:text-sm",
        // Abbreviations
